namespace pry.FormulariosMeetHub
{
    partial class frmTrabajadores
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitulo = new Label();
            pnlTrabajador.SuspendLayout();
            SuspendLayout();
            // 
            // pnlTrabajador
            // 
            pnlTrabajador.BackColor = Color.White;
            pnlTrabajador.Controls.Add(cmbAreas);
            pnlTrabajador.Controls.Add(txtMatricula);
            pnlTrabajador.Controls.Add(txtEstado);
            pnlTrabajador.Controls.Add(txtCp);
            pnlTrabajador.Controls.Add(txtCiudad);
            pnlTrabajador.Controls.Add(txtColonia);
            pnlTrabajador.Controls.Add(txtCalle);
            pnlTrabajador.Controls.Add(txtCorreo);
            pnlTrabajador.Controls.Add(txtAMaterno);
            pnlTrabajador.Controls.Add(txtAPaterno);
            pnlTrabajador.Controls.Add(txtTelefono);
            pnlTrabajador.Controls.Add(txtNombre);
            pnlTrabajador.Controls.Add(btnCancelar);
            pnlTrabajador.Controls.Add(btnGuardar);
            pnlTrabajador.Location = new Point(0, 68);
            pnlTrabajador.Name = "pnlTrabajador";
            pnlTrabajador.Size = new Size(542, 449);
            pnlTrabajador.TabIndex = 83;
            // 
            // cmbAreas
            // 
            cmbAreas.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            cmbAreas.ForeColor = SystemColors.WindowText;
            cmbAreas.FormattingEnabled = true;
            cmbAreas.Location = new Point(296, 22);
            cmbAreas.Name = "cmbAreas";
            cmbAreas.Size = new Size(218, 29);
            cmbAreas.TabIndex = 91;
            // 
            // txtMatricula
            // 
            ...
            txtEstado.Location = new Point(296, 321);
            ...
            txtCp.Location = new Point(296, 259);
            ...
            txtCiudad.Location = new Point(296, 199);
            ...
            txtColonia.Location = new Point(296, 140);
            ...
            txtCalle.Location = new Point(296, 81);
            ...
            txtCorreo.Location = new Point(19, 259);
            ...
            txtAMaterno.Location = new Point(19, 199);
            ...
            txtAPaterno.Location = new Point(19, 140);
            ...
            txtTelefono.Location = new Point(19, 321);
            ...
            txtNombre.Location = new Point(19, 81);
            ...
            lblTitulo.TabIndex = 82;
            lblTitulo.Text = "Nuevo responsable trabajador";
            // 
            // frmTrabajadores
            // 
            ...
            Controls.Add(pnlTrabajador);
            Controls.Add(lblTitulo);
            FormBorderStyle = FormBorderStyle.None;
            Name = "frmTrabajadores";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Trabajadores";
            pnlTrabajador.ResumeLayout(false);
            pnlTrabajador.PerformLayout();
            ResumeLayout(false);
            PerformLayout();
        }
