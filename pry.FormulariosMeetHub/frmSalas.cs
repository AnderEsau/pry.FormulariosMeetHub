...
namespace pry.FormulariosMeetHub
{
    public partial class frmSalas : Form
    {
        ...
        private void dgvSalas_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                // En este campo oculto  servirá de referencia para actualizar y eliminar
        ...
        // Evento del botón Guardar (btnGuardar)
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Por favor, introduce un nombre para la Sala.", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                if (txtDescripcion.Text.Trim() == "")
                {
                    MessageBox.Show("Por favor, introduce una descripción para la Sala.", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                salas.Capacidad = int.Parse(txtAforo.Text); // Guardamos el aforo numérico en Capacidad
        ...
        // Evento del botón Nuevo (btnNuevo)
        ...
        // Evento del botón Eliminar (btnEliminar)
